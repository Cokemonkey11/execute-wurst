...
function CreateNeutralPassive takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hspt', -130.9, 72.0, 258.240 )
endfunction
...
function InitAllyPriorities takes nothing returns nothing
    ...
    call SetStartLocPrio( 0, 0, 16, MAP_LOC_PRIO_LOW )
    ...
    call SetStartLocPrio( 22, 1, 4, MAP_LOC_PRIO_LOW )
